...
class QLearningAgent(BaseAgent):
    ...
    def agent_step(self, reward, observation):
        ...
        # --------------------------
        # your code here
        delta = self.step_size*(reward + self.discount*self.q[state,self.argmax(current_q)] - self.q[self.prev_state, self.prev_action])
        self.q[self.prev_state, self.prev_action] += delta
        # --------------------------
        self.prev_state = state
        self.prev_action = action
        return action
