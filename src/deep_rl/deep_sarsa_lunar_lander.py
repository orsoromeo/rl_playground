...
Original file is located at
    https://colab.research.google.com/drive/1Q-cDQYbZFrRHrsf28N_YBRz_eyJZ6WaU
"""
...
import os
from utils import simulate, plot_durations, plot_total_rewards
...
def optimize_model():
    ...
    expected_state_action_values = (sarsa_expected_returns * GAMMA) + reward_batch
...
for i_episode in range(num_episodes):
    ...
    for t in count():
        ...
        if done:
            ...
            plot_total_rewards(episode_total_rewards)
            break
...
plt.ioff()
plt.savefig("figs/sarsa_lunar_lander_"+str(num_episodes)+"e_mse.png")
plt.show()
