...
class MountainCarTileCoder:
    ...
    def get_tiles(self, position, velocity):
        ...
        # your code here
        pos_range = 1.2 + 0.5
        position_scaled = (position + 1.2)/pos_range*self.num_tiles
        vel_range = 0.14
        velocity_scaled = (velocity + 0.07)/vel_range*self.num_tiles
        # ----------------
...
class SarsaAgent(BaseAgent):
    ...
    def select_action(self, tiles):
        ...
        for a in np.arange(self.num_actions):
            action_value = np.sum(self.w[a][tiles])
        ...
        # ----------------
#         print("chosen action and value", chosen_action, action_values[chosen_action])
    ...
    def agent_step(self, reward, state):
        ...
        target = reward + self.gamma*current_value
        previous_value = np.sum(self.w[self.last_action][self.previous_tiles])
        self.w[self.last_action][self.previous_tiles] += self.alpha*(target - previous_value)
