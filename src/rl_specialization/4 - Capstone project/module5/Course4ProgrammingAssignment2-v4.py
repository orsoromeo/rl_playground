...
action_values = rand_generator.normal(0, 1, (3, 6))
assert((np.argmax(action_values, axis=1) == np.argmax(softmax(action_values, tau), axis=1)).all())
...
#     print("target", target_vec.shape, v_next_vec.shape, terminals.shape, rewards.shape)
...
#     print("sizes", q_mat.shape, q_vec.shape, actions)
    ...
    def agent_step(self, reward, state):
        ...
        if self.replay_buffer.size() > self.replay_buffer.minibatch_size:
            ...
            for _ in range(self.num_replay):
                ...
                # your code here
                optimize_network(experiences, self.discount, optimizer, network, current_q, self.tau)
